...
const PRODUCTS = [
  ...
  {id:'w3', cat:'wellness', name:"Orange Gel Exfoliant", subtitle:"Wellness", price:12, img:'images/orange.jpeg', seed:'wellness-orange-gel', desc:"Gel exfoliant doux à l'orange. Élimine les impuretés et laisse la peau fraîche et revitalisée.", ingredients:"Extrait d'orange, acide glycolique doux, glycérine.", rating:4.4, reviews:13},
  ...
  {id:'b37', cat:'body', name:"CeraVe Cleanser", subtitle:"Savon", price:14, img:'images/CeraVe Cleanser.jpeg', seed:'savon-cerave', desc:"Nettoyant doux CeraVe aux céramides. Respecte la barrière cutanée. Sans parfum.", ingredients:"Céramides, acide hyaluronique, niacinamide.", rating:4.7, reviews:20},
  ...
  {id:'f5', cat:'face', name:"Jennie Moon Pro Derma", subtitle:"Visage", price:32, img:'images/Jennie MOON PRO DERMA.jpeg', seed:'face-jennie-moon', desc:"Crème coréenne Jennie Moon. Technologie pro-derma pour une peau parfaite.", ingredients:"Peptides, céramides, extrait de centella asiatica.", rating:4.7, reviews:19, badge:'Premium'},
  {id:'f6', cat:'face', name:"Parley Beauty Cream", subtitle:"Visage", price:25, img:'images/Parley.jpeg', seed:'face-parley', desc:"Crème visage Parley Beauty. Nutrition intense et éclat durable.", ingredients:"Huile de coco, beurre de mangue, vitamine E.", rating:4.5, reviews:12},
  {id:'f7', cat:'face', name:"Dr. Althea 345", subtitle:"Visage", price:30, img:'images/Dr. Althea 345.jpeg', seed:'face-dr-althea-345', desc:"Crème apaisante Dr. Althea 345. Calme les irritations et renforce la barrière cutanée.", ingredients:"Centella asiatica, panthénol, niacinamide.", rating:4.7, reviews:18},
  {id:'f8', cat:'face', name:"Dr. Althea 147", subtitle:"Visage", price:30, img:'images/Dr. ALTHEA 147.jpeg', seed:'face-dr-althea-147', desc:"Crème régénérante Dr. Althea 147. Reparation et nutrition intense.", ingredients:"Miel de manuka, propolis, beurre de karité.", rating:4.6, reviews:15},
  ...
  {id:'f10', cat:'face', name:"Saam Cream", subtitle:"Visage", price:18, img:'images/Saam.jpeg', seed:'face-saam', desc:"Crème visage Saam. Soin quotidien pour une peau saine et éclatante.", ingredients:"Beurre de karité, huile d'amande douce, glycérine.", rating:4.4, reviews:10},
  {id:'f11', cat:'face', name:"Kojic Cream", subtitle:"Visage", price:21, img:'images/Kojic crème.jpeg', seed:'face-kojic-cream', desc:"Crème visage à l'acide kojique. Éclaircissante et protectrice.", ingredients:"Acide kojique 2%, niacinamide, filtres UV.", rating:4.6, reviews:14},
  ...
  {id:'f13', cat:'face', name:"COSRX Crème", subtitle:"Visage", price:28, img:'images/COSRX.jpeg', seed:'face-cosrx', desc:"Crème COSRX. Soin apaisant et réparateur à la mucine d'escargot.", ingredients:"Mucine d'escargot 96%, extrait de feuille d'olivier.", rating:4.8, reviews:23},
  {id:'f14', cat:'face', name:"CeraVe Crème Visage", subtitle:"Visage", price:24, img:'images/Cerave crème.jpeg', seed:'face-cerave', desc:"Crème hydratante CeraVe aux céramides. Hydratation longue durée.", ingredients:"Céramides, acide hyaluronique, niacinamide.", rating:4.7, reviews:19},
  {id:'f15', cat:'face', name:"La Roche Posay", subtitle:"Visage", price:33, img:'images/La roche Posay.jpeg', seed:'face-lrp', desc:"Crème dermatologique La Roche Posay. Tolérance maximale et efficacité prouvée.", ingredients:"Eau thermale de La Roche Posay, niacinamide, shea butter.", rating:4.8, reviews:25, badge:'Premium'},
  ...
  {id:'f17', cat:'face', name:"Joseon Beauty Cream", subtitle:"Visage", price:19, img:'images/Joseon Beauty cream.jpeg', seed:'face-jeason', desc:"Crème Joseon Beauty. Soin visage complet pour un teint frais et unifié.", ingredients:"Complexe Joseon, huile de jojoba, aloe vera.", rating:4.4, reviews:9},
  {id:'f18', cat:'face', name:"Anua 77%", subtitle:"Visage", price:27, img:'images/Anua 77.jpeg', seed:'face-anua-77', desc:"Sérum-crème Anua 77% à l'extrait d'huile d'olive. Hydratation coréenne intense.", ingredients:"Extrait d'huile d'olive 77%, squalane, panthénol.", rating:4.7, reviews:17},
  {id:'f19', cat:'face', name:"Anua 70%", subtitle:"Visage", price:27, img:'images/Anua 70.jpeg', seed:'face-anua-70', desc:"Crème Anua 70% à la centella. Apaise et répare les peaux sensibles.", ingredients:"Extrait de centella asiatica 70%, niacinamide, madecassoside.", rating:4.6, reviews:15},
];
        ...
        <section>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
            <label onclick="switchPay(this, 'mp')" class="relative flex flex-col items-center gap-2 p-4 border border-primary bg-surface-container-low cursor-pointer text-center shadow-sm">
              ...
              <span class="pay-check absolute -top-2 -right-2 w-5 h-5 rounded-full bg-primary text-on-primary flex items-center justify-center"><span class="material-symbols-outlined text-xs" style="font-size:14px">check</span></span>
            ...
            <label onclick="switchPay(this, 'am')" class="relative flex flex-col items-center gap-2 p-4 border border-outline-variant/30 cursor-pointer text-center">
              ...
              <span class="pay-check absolute -top-2 -right-2 w-5 h-5 rounded-full bg-primary text-on-primary flex items-center justify-center hidden"><span class="material-symbols-outlined text-xs" style="font-size:14px">check</span></span>
