...
const PRODUCTS = [
  ...
  /* ===== BIEN-ÊTRE ===== */
  {id:'w2', cat:'wellness', name:"Masques de Visage", subtitle:"Wellness", price:5, seed:'wellness-masques', desc:"Masques visage hydratants et purifiants. Selon votre type de peau pour un teint frais et lumineux.", ingredients:"Argile verte, aloe vera, extrait de concombre.", rating:4.5, reviews:18},
  ...
  {id:'w13', cat:'wellness', name:"Keto Tea", subtitle:"Wellness", price:25, seed:'wellness-keto-tea', desc:"Thé adapté au régime cétogène. Booste le métabolisme et l'énergie.", ingredients:"Thé oolong, MCT, électrolytes naturels.", rating:4.3, reviews:12},
  ...
  {id:'b30', cat:'body', name:"Moroccan Argan Soap", subtitle:"Savon", price:15, seed:'savon-argan', desc:"Savon marocain à l'huile d'argan. Nourrit et nettoie sans agresser la peau.", ingredients:"Huile d'argan, huile d'olive, argile ghassoul.", rating:4.6, reviews:16},
  ...
  {id:'b32', cat:'body', name:"Advanced Whitening Soap", subtitle:"Savon", price:15, seed:'savon-advanced-whitening', desc:"Savon éclaircissant avancé. Formule concentrée pour un résultat visible.", ingredients:"Arbutine, vitamine C, extrait de citron.", rating:4.6, reviews:15},
  {id:'b33', cat:'body', name:"Half Cast Soap", subtitle:"Savon", price:15, seed:'savon-half-cast', desc:"Savon éclaircissant Half Cast. Nettoie et atténue les taches pigmentaires.", ingredients:"Extrait de citron, huile de coco, glycérine.", rating:4.3, reviews:8},
  {id:'b34', cat:'body', name:"Cindella Soap", subtitle:"Savon", price:20, seed:'savon-cindella', desc:"Savon Cindella à la formule exclusive. Laisse la peau propre, douce et éclatante.", ingredients:"Complexe Cindella, huile d'amande, beurre de karité.", rating:4.5, reviews:10},
