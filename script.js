...
const PRODUCTS = [
  ...
  {id:'w1', cat:'wellness', name:"Flat Tummy Tea", subtitle:"Wellness", price:30, img:'images/flat-tummy-tea-beta-1.webp', seed:'wellness-tea', desc:"Infusion minceur naturelle aux actifs puissants. Formule douce et efficace. Saveur agréable et relaxante.", ingredients:"Thé vert bio, gingembre, menthe, cannelle, aneth.", rating:4.6, reviews:27},
  /* ===== BIEN-ÊTRE ===== */
  ...
  {id:'w4', cat:'wellness', name:"Adeus Cream", subtitle:"Wellness", price:30, seed:'wellness-adeus', desc:"Crème minceur Adeus. Formule thermo-active pour affiner la silhouette.", ingredients:"Caféine, L-carnitine, extrait d'algues.", rating:4.3, reviews:11},
  ...
  {id:'w12', cat:'wellness', name:"Fit Tea", subtitle:"Wellness", price:25, seed:'wellness-fit-tea', desc:"Infusion minceur detox. Purifie l'organisme et favorise la perte de poids.", ingredients:"Thé vert, guarana, maté, gingembre.", rating:4.4, reviews:16},
  ...
  {id:'b21', cat:'body', name:"Olay Lotion", subtitle:"Lait", price:40, seed:'lait-olay', desc:"Lotion hydratante Olay. Hydratation 24h et soin anti-âge pour le corps.", ingredients:"Vitamine B3, acide hyaluronique, pro-vitamine B5.", rating:4.6, reviews:14},
  {id:'b22', cat:'body', name:"Medix 5.5 Lotion", subtitle:"Lait", price:40, seed:'lait-medix', desc:"Lait corporel dermatologique Medix 5.5. Équilibre le pH et hydrate en douceur.", ingredients:"Complexe Medix 5.5, aloe vera, panthénol.", rating:4.4, reviews:8},
  ...
  {id:'b31', cat:'body', name:"AHA Savon", subtitle:"Savon", price:15, seed:'savon-aha', desc:"Savon exfoliant aux AHA. Nettoie et renouvelle la peau en douceur.", ingredients:"Acide glycolique, aloe vera, glycérine.", rating:4.5, reviews:11},
  ...
  {id:'b36', cat:'body', name:"Savon Œuf", subtitle:"Savon", price:20, seed:'savon-oeuf', desc:"Savon à l'œuf. Riche en protéines pour une peau nourrie et régénérée.", ingredients:"Extrait d'œuf, huile d'olive, glycérine naturelle.", rating:4.3, reviews:7},
