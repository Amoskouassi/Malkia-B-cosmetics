...
const PRODUCTS = [
  ...
  {id:'w5', cat:'wellness', name:"Gluthamax White", subtitle:"Wellness", price:50, seed:'wellness-gluthamax', desc:"Complément éclat au glutathion max. Blanchissant et antioxydant puissant.", ingredients:"Glutathion 500mg, vitamine C 100mg, acide folique.", rating:4.6, reviews:22},
  ...
  {id:'w8', cat:'wellness', name:"Vitamine Gummies", subtitle:"Wellness", price:50, seed:'wellness-vita-gummies', desc:"Gommes multivitaminées. Énergie quotidienne et renforcement immunitaire.", ingredients:"Vitamines A, C, D, E, B6, B12, zinc.", rating:4.5, reviews:20},
  {id:'w9', cat:'wellness', name:"Vitamine Ascorbic Acid", subtitle:"Wellness", price:100, seed:'wellness-vitamine-c', desc:"Vitamine C pure en poudre ou comprimés. Antioxydant essentiel pour l'éclat de la peau.", ingredients:"Acide ascorbique 1000mg, bioflavonoïdes.", rating:4.6, reviews:17},
  {id:'w10', cat:'wellness', name:"Curves Extreme", subtitle:"Wellness", price:50, seed:'wellness-curves', desc:"Complément alimentaire pour galbe et courbes. Formule enrichie en plantes et vitamines.", ingredients:"Fenugrec, maca, collagène, biotine.", rating:4.3, reviews:24},
  ...
  {id:'b11', cat:'body', name:"Cindella Lotion", subtitle:"Lait", price:60, seed:'lait-cindella', desc:"Lotion éclat à la formule exclusive. Illumine la peau et laisse un fini satiné.", ingredients:"Complexe Cindella, huile d'argan, beurre de karité.", rating:4.5, reviews:10},
  ...
  {id:'b23', cat:'body', name:"Bride Cream Lotion", subtitle:"Lait", price:50, seed:'lait-bride-cream', desc:"Préparation intense pour future mariée. Éclat extrême et peau de velours pour le grand jour.", ingredients:"Collagène, élastine, extrait de perle, vitamine E.", rating:4.8, reviews:22, badge:'Vedette'},
