...
const PRODUCTS = [
  ...
  /* ===== PARFUMS ===== */
  {id:'r3', cat:'fragrance', name:"Sauvage Dior", subtitle:"Parfums", price:89, img:'images/Sauvage Dior.jpeg', seed:'parfum-sauvage-dior', desc:"Eau de toilette iconique Dior. Fraîcheur épicée et virile. Notes de bergamote, poivre et ambre.", ingredients:"Bergamote, poivre de Sichuan, ambre gris.", rating:4.9, reviews:45, badge:'Premium'},
  {id:'r4', cat:'fragrance', name:"Baccarat Rouge 540 — Francis Kurkdjian", subtitle:"Parfums", price:120, img:'images/baccarat rouge.jpeg', seed:'parfum-baccarat-rouge', desc:"Fragrance légendaire signée Francis Kurkdjian. Note safranée et boisée inoubliable.", ingredients:"Safran, cèdre, ambre gras, ciste.", rating:5.0, reviews:62, badge:'Premium'},
  {id:'r5', cat:'fragrance', name:"Baccarat Blanc — Francis Kurkdjian", subtitle:"Parfums", price:120, img:'images/Baccarat blanc.jpeg', seed:'parfum-baccarat-blanc', desc:"Version lumineuse du Baccarat. Notes fraîches et florales. Élégance pure.", ingredients:"Fleur d'oranger, musc blanc, vanille.", rating:4.8, reviews:28, badge:'Premium'},
  {id:'r6', cat:'fragrance', name:"Baccarat Noire — Francis Kurkdjian", subtitle:"Parfums", price:125, img:'images/Baccarat noir.jpeg', seed:'parfum-baccarat-noire', desc:"Variation intense et mystérieuse du Baccarat. Profondeur envoûtante.", ingredients:"Oud, cuir, bois de santal, safran.", rating:4.9, reviews:34, badge:'Premium'},
  {id:'r7', cat:'fragrance', name:"Terre d'Hermès", subtitle:"Parfums", price:95, img:'images/Terre d\'Hermès.jpeg', seed:'parfum-terre-hermes', desc:"Parfum emblématique Hermès aux notes minérales et boisées. Élégance intemporelle.", ingredients:"Pamplemousse, silex, cèdre, vétiver.", rating:4.8, reviews:41},
  {id:'r8', cat:'fragrance', name:"Badel Al Oud", subtitle:"Parfums", price:65, img:'images/Badee al oud.jpeg', seed:'parfum-badel-al-oud', desc:"Parfum oriental riche au oud noble. Sillage envoûtant et tenue exceptionnelle.", ingredients:"Oud naturel, musc, ambre, bois de santal.", rating:4.7, reviews:23},
  {id:'r9', cat:'fragrance', name:"Scandal", subtitle:"Parfums", price:55, img:'images/Scandal.jpeg', seed:'parfum-scandal', desc:"Parfum audacieux aux notes de miel et de fleur d'oranger. Gourmand et sensuel.", ingredients:"Miel, fleur d'oranger, patchouli, vanille.", rating:4.6, reviews:19},
  {id:'r10', cat:'fragrance', name:"Dubai Chocolat", subtitle:"Parfums", price:45, img:'images/Dubai chocolat.jpeg', seed:'parfum-dubai-chocolat', desc:"Fragrance gourmande au cacao et aux épices orientales. Un parfum réconfortant et luxueux.", ingredients:"Cacao, cannelle, vanille, musc.", rating:4.5, reviews:16},
  {id:'r11', cat:'fragrance', name:"Teriaq", subtitle:"Parfums", price:50, img:'images/Teriaq.jpeg', seed:'parfum-teriaq', desc:"Parfum oriental captivant. Notes épicées et boisées pour une signature forte.", ingredients:"Cardamome, cuir, oud, ambre.", rating:4.6, reviews:14},
  ...
  {id:'r15', cat:'fragrance', name:"Nine Noire", subtitle:"Parfums", price:40, img:'images/Nine noir.jpeg', seed:'parfum-nine-noire', desc:"Nine en version sombre et intense. Mystère et élégance.", ingredients:"Cuir, oud, poivre noir, ambre.", rating:4.6, reviews:13},
  {id:'r16', cat:'fragrance', name:"Nine Beige", subtitle:"Parfums", price:40, img:'images/Nine beige.jpeg', seed:'parfum-nine-beige', desc:"Nine en version douce et lumineuse. Élégance minimaliste.", ingredients:"Musc blanc, fleur d'oranger, vanille.", rating:4.5, reviews:11},
  {id:'r17', cat:'fragrance', name:"Nine Blue", subtitle:"Parfums", price:40, img:'images/Nine blue.jpeg', seed:'parfum-nine-blue', desc:"Nine en version aquatique et fraîche. Brise marine et liberté.", ingredients:"Notes marines, bergamote, cèdre.", rating:4.6, reviews:14},
  {id:'r18', cat:'fragrance', name:"Club de Nuit Homme", subtitle:"Parfums", price:50, img:'images/Club de nuit homme.jpeg', seed:'parfum-club-nuit-homme', desc:"Parfum masculin puissant. Sillage longue durée. Notes fumées et boisées.", ingredients:"Bergamote, ananas, bouleau, ambre.", rating:4.7, reviews:29},
  {id:'r19', cat:'fragrance', name:"Club de Nuit Femme", subtitle:"Parfums", price:50, img:'images/Club de nuit femme.jpeg', seed:'parfum-club-nuit-femme', desc:"Parfum féminin envoûtant. Notes fruitées et florales intenses.", ingredients:"Fraise, rose, patchouli, musc.", rating:4.7, reviews:25},
  {id:'r20', cat:'fragrance', name:"Bleu de Chanel", subtitle:"Parfums", price:105, img:'images/Blue Chanel.jpeg', seed:'parfum-bleu-chanel', desc:"Parfum emblématique Chanel. Fraîcheur boisée et aromatique. Signature masculine sophistiquée.", ingredients:"Pamplemousse, gingembre, cèdre, santal.", rating:4.9, reviews:55, badge:'Premium'},
  {id:'r21', cat:'fragrance', name:"La Vie Est Belle", subtitle:"Parfums", price:80, img:'images/La ville est belle.jpeg', seed:'parfum-vie-est-belle', desc:"Parfum iconique Lancôme. Bonheur en flacon. Notes de gourmandise et de floral.", ingredients:"Iris, jasmin, praline, vanille, patchouli.", rating:4.8, reviews:38},
  {id:'r22', cat:'fragrance', name:"Moussuf Bleu", subtitle:"Parfums", price:30, img:'images/Mousuf Aswad.jpeg', seed:'parfum-moussuf-bleu', desc:"Moussuf version bleue. Fraîcheur aquatique et florale.", ingredients:"Notes marines, lavande, musc.", rating:4.4, reviews:12},
  {id:'r23', cat:'fragrance', name:"Moussuf Rouge", subtitle:"Parfums", price:30, img:'images/Mousuf Sexy.jpeg', seed:'parfum-moussuf-rouge', desc:"Moussuf version rouge. Passion et intensité.", ingredients:"Fraise, rose rouge, ambre.", rating:4.5, reviews:10},
  {id:'r24', cat:'fragrance', name:"Moussuf Rose", subtitle:"Parfums", price:30, img:'images/Mousuf Wardi.jpeg', seed:'parfum-moussuf-rose', desc:"Moussuf version rose. Douceur florale et romantique.", ingredients:"Rose, pivoine, musc blanc.", rating:4.4, reviews:9},
  ...
  {id:'r26', cat:'fragrance', name:"Moussuf Blanc", subtitle:"Parfums", price:30, img:'images/Mousf Musk.jpeg', seed:'parfum-moussuf-blanc', desc:"Moussuf version blanche. Pureté et élégance minimaliste.", ingredients:"Fleur d'oranger, musc, vanille.", rating:4.3, reviews:8},
  {id:'r30', cat:'fragrance', name:"Moussuf Gris", subtitle:"Parfums", price:30, img:'images/Mousuf Ramadi.jpeg', seed:'parfum-moussuf-ramadi', desc:"Moussuf version grise. Élégance sobre et moderne.", ingredients:"Cèdre, poivre rose, musc gris.", rating:4.3, reviews:6},
