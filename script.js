...
const PRODUCTS = [
  ...
  {id:'r7', cat:'fragrance', name:"Terre d'Hermès", subtitle:"Parfums", price:100, img:'images/Terre-d-Hermes.jpeg', seed:'parfum-terre-hermes', desc:"Parfum emblématique Hermès aux notes minérales et boisées. Élégance intemporelle.", ingredients:"Pamplemousse, silex, cèdre, vétiver.", rating:4.8, reviews:41},
  ...
  {id:'r10', cat:'fragrance', name:"Dubai Chocolat", subtitle:"Parfums", price:100, img:'images/Dubai chocolat.jpeg', seed:'parfum-dubai-chocolat', desc:"Fragrance gourmande au cacao et aux épices orientales. Un parfum réconfortant et luxueux.", ingredients:"Cacao, cannelle, vanille, musc.", rating:4.5, reviews:16},
  {id:'r11', cat:'fragrance', name:"Teriaq", subtitle:"Parfums", price:100, img:'images/Teriaq.jpeg', seed:'parfum-teriaq', desc:"Parfum oriental captivant. Notes épicées et boisées pour une signature forte.", ingredients:"Cardamome, cuir, oud, ambre.", rating:4.6, reviews:14},
  {id:'r12', cat:'fragrance', name:"Yara Rouge", subtitle:"Parfums", price:100, img:'images/Yara rouge.jpeg', seed:'parfum-yara-rouge', desc:"Yara dans sa version rouge passion. Notes fruitées et florales vibrantes.", ingredients:"Fraise, framboise, rose, musc blanc.", rating:4.5, reviews:18},
  {id:'r13', cat:'fragrance', name:"Yara Jaune", subtitle:"Parfums", price:100, img:'images/Yara jaune.jpeg', seed:'parfum-yara-jaune', desc:"Yara version solaire. Lumière et joie dans un flacon. Notes exotiques enveloppantes.", ingredients:"Mangue, ylang-ylang, vanille, santal.", rating:4.6, reviews:15},
  {id:'r14', cat:'fragrance', name:"Yara Rose", subtitle:"Parfums", price:100, img:'images/yara rose.jpeg', seed:'parfum-yara-rose', desc:"Yara version florale. Bouquet romantique de roses et de fruits rouges.", ingredients:"Rose bulgare, litchi, musc doux.", rating:4.7, reviews:20},
  {id:'r27', cat:'fragrance', name:"Yara Gris", subtitle:"Parfums", price:100, img:'images/yara gris.jpeg', seed:'parfum-yara-gris', desc:"Yara version grisée. Élégance sobre et sophistiquée. Notes boisées et épicées.", ingredients:"Poivre rose, iris, cèdre, musc.", rating:4.6, reviews:10},
  {id:'r15', cat:'fragrance', name:"Nine Noire", subtitle:"Parfums", price:100, img:'images/Nine noir.jpeg', seed:'parfum-nine-noire', desc:"Nine en version sombre et intense. Mystère et élégance.", ingredients:"Cuir, oud, poivre noir, ambre.", rating:4.6, reviews:13},
  {id:'r16', cat:'fragrance', name:"Nine Beige", subtitle:"Parfums", price:100, img:'images/Nine beige.jpeg', seed:'parfum-nine-beige', desc:"Nine en version douce et lumineuse. Élégance minimaliste.", ingredients:"Musc blanc, fleur d'oranger, vanille.", rating:4.5, reviews:11},
  {id:'r17', cat:'fragrance', name:"Nine Blue", subtitle:"Parfums", price:100, img:'images/Nine blue.jpeg', seed:'parfum-nine-blue', desc:"Nine en version aquatique et fraîche. Brise marine et liberté.", ingredients:"Notes marines, bergamote, cèdre.", rating:4.6, reviews:14},
  {id:'r18', cat:'fragrance', name:"Club de Nuit Homme", subtitle:"Parfums", price:100, img:'images/Club de nuit homme.jpeg', seed:'parfum-club-nuit-homme', desc:"Parfum masculin puissant. Sillage longue durée. Notes fumées et boisées.", ingredients:"Bergamote, ananas, bouleau, ambre.", rating:4.7, reviews:29},
  {id:'r19', cat:'fragrance', name:"Club de Nuit Femme", subtitle:"Parfums", price:100, img:'images/Club de nuit femme.jpeg', seed:'parfum-club-nuit-femme', desc:"Parfum féminin envoûtant. Notes fruitées et florales intenses.", ingredients:"Fraise, rose, patchouli, musc.", rating:4.7, reviews:25},
  {id:'r20', cat:'fragrance', name:"Bleu de Chanel", subtitle:"Parfums", price:100, img:'images/Blue Chanel.jpeg', seed:'parfum-bleu-chanel', desc:"Parfum emblématique Chanel. Fraîcheur boisée et aromatique. Signature masculine sophistiquée.", ingredients:"Pamplemousse, gingembre, cèdre, santal.", rating:4.9, reviews:55, badge:'Premium'},
  {id:'r21', cat:'fragrance', name:"La Vie Est Belle", subtitle:"Parfums", price:100, img:'images/La ville est belle.jpeg', seed:'parfum-vie-est-belle', desc:"Parfum iconique Lancôme. Bonheur en flacon. Notes de gourmandise et de floral.", ingredients:"Iris, jasmin, praline, vanille, patchouli.", rating:4.8, reviews:38},
  {id:'r22', cat:'fragrance', name:"Moussuf Bleu", subtitle:"Parfums", price:25, img:'images/Mousuf Aswad.jpeg', seed:'parfum-moussuf-bleu', desc:"Moussuf version bleue. Fraîcheur aquatique et florale.", ingredients:"Notes marines, lavande, musc.", rating:4.4, reviews:12},
  {id:'r23', cat:'fragrance', name:"Moussuf Rouge", subtitle:"Parfums", price:25, img:'images/Mousuf Sexy.jpeg', seed:'parfum-moussuf-rouge', desc:"Moussuf version rouge. Passion et intensité.", ingredients:"Fraise, rose rouge, ambre.", rating:4.5, reviews:10},
  {id:'r24', cat:'fragrance', name:"Moussuf Rose", subtitle:"Parfums", price:25, img:'images/Mousuf Wardi.jpeg', seed:'parfum-moussuf-rose', desc:"Moussuf version rose. Douceur florale et romantique.", ingredients:"Rose, pivoine, musc blanc.", rating:4.4, reviews:9},
  {id:'r25', cat:'fragrance', name:"Moussuf Chocolat", subtitle:"Parfums", price:25, img:'images/Mousuf Chocolat.jpeg', seed:'parfum-moussuf-choco', desc:"Moussuf version chocolatée. Gourmandise addictive.", ingredients:"Cacao, vanille, caramel.", rating:4.5, reviews:11},
  {id:'r26', cat:'fragrance', name:"Moussuf Blanc", subtitle:"Parfums", price:25, img:'images/Mousf Musk.jpeg', seed:'parfum-moussuf-blanc', desc:"Moussuf version blanche. Pureté et élégance minimaliste.", ingredients:"Fleur d'oranger, musc, vanille.", rating:4.3, reviews:8},
  {id:'r30', cat:'fragrance', name:"Moussuf Gris", subtitle:"Parfums", price:25, img:'images/Mousuf Ramadi.jpeg', seed:'parfum-moussuf-ramadi', desc:"Moussuf version grise. Élégance sobre et moderne.", ingredients:"Cèdre, poivre rose, musc gris.", rating:4.3, reviews:6},
  {id:'w1', cat:'wellness', name:"Flat Tummy Tea", subtitle:"Wellness", price:30, img:'images/Flat tummy tea.jpeg', seed:'wellness-tea', desc:"Infusion minceur naturelle aux actifs puissants. Formule douce et efficace. Saveur agréable et relaxante.", ingredients:"Thé vert bio, gingembre, menthe, cannelle, aneth.", rating:4.6, reviews:27},
  /* ===== BIEN-ÊTRE ===== */
  {id:'w2', cat:'wellness', name:"Masques de Visage", subtitle:"Wellness", price:5, img:'images/Mask.jpeg', gallery:['images/Mask.jpeg','images/Mask (2).jpeg'], seed:'wellness-masques', desc:"Masques visage hydratants et purifiants. Selon votre type de peau pour un teint frais et lumineux.", ingredients:"Argile verte, aloe vera, extrait de concombre.", rating:4.5, reviews:18},
  {id:'w3', cat:'wellness', name:"Orange Gel Exfoliant", subtitle:"Wellness", price:25, img:'images/orange.jpeg', seed:'wellness-orange-gel', desc:"Gel exfoliant doux à l'orange. Élimine les impuretés et laisse la peau fraîche et revitalisée.", ingredients:"Extrait d'orange, acide glycolique doux, glycérine.", rating:4.4, reviews:13},
  {id:'w4', cat:'wellness', name:"Adeus Cream", subtitle:"Wellness", price:30, img:'images/Adeus cream.jpeg', seed:'wellness-adeus', desc:"Crème minceur Adeus. Formule thermo-active pour affiner la silhouette.", ingredients:"Caféine, L-carnitine, extrait d'algues.", rating:4.3, reviews:11},
  {id:'w5', cat:'wellness', name:"Gluthamax White", subtitle:"Wellness", price:50, img:'images/Gluthamax white.jpeg', seed:'wellness-gluthamax', desc:"Complément éclat au glutathion max. Blanchissant et antioxydant puissant.", ingredients:"Glutathion 500mg, vitamine C 100mg, acide folique.", rating:4.6, reviews:22},
  {id:'w6', cat:'wellness', name:"Multi Collagen Peptides", subtitle:"Wellness", price:50, img:'images/Multi collagene peptides.jpeg', seed:'wellness-multi-collagen', desc:"Collagène multi-peptides pour peau, cheveux et articulations. Haute biodisponibilité.", ingredients:"Collagène hydrolysé type I, II, III, V, X, acide hyaluronique.", rating:4.7, reviews:29},
  {id:'w7', cat:'wellness', name:"Glutathione Gummies", subtitle:"Wellness", price:50, img:'images/Glutathione gummies.jpeg', seed:'wellness-gluta-gummies', desc:"Gommes au glutathion. Sublimez votre éclat de l'intérieur. Format pratique et gourmand.", ingredients:"Glutathion, vitamine C, pectine naturelle.", rating:4.4, reviews:15},
  {id:'w8', cat:'wellness', name:"Vitamine Gummies", subtitle:"Wellness", price:50, img:'images/Vitamie C gummies.jpeg', seed:'wellness-vita-gummies', desc:"Gommes multivitaminées. Énergie quotidienne et renforcement immunitaire.", ingredients:"Vitamines A, C, D, E, B6, B12, zinc.", rating:4.5, reviews:20},
  {id:'w9', cat:'wellness', name:"Vitamine Ascorbic Acid", subtitle:"Wellness", price:100, img:'images/Vitamine C absorbic.jpeg', seed:'wellness-vitamine-c', desc:"Vitamine C pure en poudre ou comprimés. Antioxydant essentiel pour l'éclat de la peau.", ingredients:"Acide ascorbique 1000mg, bioflavonoïdes.", rating:4.6, reviews:17},
  {id:'w10', cat:'wellness', name:"Curves Extreme", subtitle:"Wellness", price:50, img:'images/curves extreme.jpeg', seed:'wellness-curves', desc:"Complément alimentaire pour galbe et courbes. Formule enrichie en plantes et vitamines.", ingredients:"Fenugrec, maca, collagène, biotine.", rating:4.3, reviews:24},
  {id:'w11', cat:'wellness', name:"Super Collagène Peptides", subtitle:"Wellness", price:50, img:'images/Collagen peptides.jpeg', seed:'wellness-super-collagen', desc:"Super collagène hydrolysé haute concentration. Rajeunissement cutané et articulaire.", ingredients:"Collagène marin type I, III, acide hyaluronique, vitamine C.", rating:4.7, reviews:31},
  {id:'w12', cat:'wellness', name:"Fit Tea", subtitle:"Wellness", price:25, img:'images/Fit tea.jpeg', seed:'wellness-fit-tea', desc:"Infusion minceur detox. Purifie l'organisme et favorise la perte de poids.", ingredients:"Thé vert, guarana, maté, gingembre.", rating:4.4, reviews:16},
  {id:'w13', cat:'wellness', name:"Keto Tea", subtitle:"Wellness", price:25, img:'images/Keto tea.jpeg', seed:'wellness-keto-tea', desc:"Thé adapté au régime cétogène. Booste le métabolisme et l'énergie.", ingredients:"Thé oolong, MCT, électrolytes naturels.", rating:4.3, reviews:12},
  {id:'w14', cat:'wellness', name:"Breas Tea", subtitle:"Wellness", price:25, img:'images/Breas tea.jpeg', seed:'wellness-breas-tea', desc:"Infusion bien-être aux plantes exotiques. Favorise la détente et l'équilibre.", ingredients:"Feuilles de bred, miel, gingembre, citronnelle.", rating:4.4, reviews:10},
  {id:'w15', cat:'wellness', name:"Acne Treatment", subtitle:"Wellness", price:40, img:'images/Acne treatment.jpeg', seed:'wellness-acne', desc:"Soin anti-acné complet. Purifie la peau et prévient les imperfections.", ingredients:"Acide salicylique, niacinamide, tea tree, zinc.", rating:4.6, reviews:27},
  {id:'w16', cat:'wellness', name:"Super Collagène", subtitle:"Wellness", price:50, img:'images/Super collagene.jpeg', seed:'wellness-super-collagen-2', desc:"Collagène pur haute dose. Pour une peau ferme, des cheveux forts et des ongles solides.", ingredients:"Collagène hydrolysé type I, vitamine C, biotine.", rating:4.6, reviews:23},
  {id:'w17', cat:'wellness', name:"FemFresh", subtitle:"Wellness", price:10, img:'images/Femfresh.jpeg', seed:'wellness-femfresh', gallery:['images/Femfresh.jpeg','images/Femfresh (2).jpeg','images/femfresh (3).jpeg','images/femfresh (4).jpeg'], desc:"Soin d'hygiène intime doux. Équilibre le pH et respecte la flore naturelle.", ingredients:"Extrait de camomille, acide lactique, aloe vera.", rating:4.5, reviews:19},
  {id:'w18', cat:'wellness', name:"Vital Proteins Collagen", subtitle:"Wellness", price:100, img:'images/Vital Protein Collagene.jpeg', seed:'wellness-vital-proteins', desc:"Collagène premium Vital Proteins. La référence américaine pour beauté intérieure.", ingredients:"Collagène bovin type I, III, acide hyaluronique, vitamine C.", rating:4.8, reviews:35, badge:'Premium'},
  {id:'w19', cat:'wellness', name:"Stretch Marks & Scar Oil", subtitle:"Wellness", price:30, img:'images/Strech marks and scars oil.jpeg', seed:'wellness-stretch-oil', desc:"Huile anti-vergetures et cicatrices. Régénère et estompe les marques cutanées.", ingredients:"Huile de rose musquée, vitamine E, beurre de cacao, centella.", rating:4.5, reviews:21},
  {id:'w20', cat:'wellness', name:"Small Molecule Collagen Solid Drink", subtitle:"Wellness", price:150, img:'images/Small molecule collagen solid drink.jpeg', seed:'wellness-collagen-drink', desc:"Boisson solide au collagène petite molécule. Absorption maximale pour un résultat visible.", ingredients:"Collagène tripeptide, céramides, extrait de raisin.", rating:4.7, reviews:26, badge:'Premium'},
  /* ===== LAITS (BODY LOTIONS) ===== */
  {id:'b4', cat:'body', name:"Déla Yellow", subtitle:"Lait", price:50, seed:'lait-dela-yellow', desc:"Lait corporel éclat à l'extrait de curcuma. Illumine et unifie le teint progressivement. Texture légère et non collante.", ingredients:"Curcuma bio, beurre de karité, vitamine E.", rating:4.5, reviews:12},
  ...
  {id:'b6', cat:'body', name:"Hi Glow", subtitle:"Lait", price:50, seed:'lait-hi-glow', desc:"Lotion éclatante pour un teint glowy. Hydrate et illumine dès la première application.", ingredients:"Niacinamide, extrait de réglisse, glycérine.", rating:4.4, reviews:9},
  ...
  {id:'b8', cat:'body', name:"Lait Thaï", subtitle:"Lait", price:30, seed:'lait-thai', desc:"Lait corporel à la tradition thaïlandaise. Hydratation intense et senteur exotique enveloppante.", ingredients:"Huile de coco, extrait de mangue, beurre de karité.", rating:4.5, reviews:11},
  ...
  {id:'b10', cat:'body', name:"Alpha Arbutin Lotion", subtitle:"Lait", price:50, seed:'lait-alpha-arbutin', desc:"Lait éclaircissant à l'alpha arbutine. Estompe les taches et unifie le teint en douceur.", ingredients:"Alpha arbutine 2%, niacinamide, acide kojique.", rating:4.7, reviews:16},
  {id:'b11', cat:'body', name:"Cindella Lotion", subtitle:"Lait", price:60, img:'images/Cindella Lotion.jpeg', seed:'lait-cindella', desc:"Lotion éclat à la formule exclusive. Illumine la peau et laisse un fini satiné.", ingredients:"Complexe Cindella, huile d'argan, beurre de karité.", rating:4.5, reviews:10},
  {id:'b12', cat:'body', name:"Kojic Lotion", subtitle:"Lait", price:15, seed:'lait-kojic', desc:"Lait corporel à l'acide kojique. Éclaircissant progressif et uniforme. Texture onctueuse.", ingredients:"Acide kojique 2%, extrait de mûrier, vitamine C.", rating:4.6, reviews:13},
  ...
  {id:'b16', cat:'body', name:"AHA Lotion Corps", subtitle:"Lait", price:20, seed:'lait-aha', desc:"Exfoliation chimique douce aux AHA pour un corps lisse et lumineux. Renouvelle la peau en profondeur.", ingredients:"Acide glycolique 5%, acide lactique, aloe vera.", rating:4.6, reviews:15},
  {id:'b17', cat:'body', name:"Vitamine C Lotion", subtitle:"Lait", price:20, img:'images/Vitamine C lotion.jpeg', seed:'lait-vitamine-c', desc:"Lotion illuminatrice riche en vitamine C stabilisée. Éclat immédiat et protection antioxydante.", ingredients:"Vitamine C 10%, extrait d'orange, vitamine E.", rating:4.5, reviews:12},
  ...
  {id:'b21', cat:'body', name:"Olay Lotion", subtitle:"Lait", price:40, img:'images/Olay.jpeg', seed:'lait-olay', desc:"Lotion hydratante Olay. Hydratation 24h et soin anti-âge pour le corps.", ingredients:"Vitamine B3, acide hyaluronique, pro-vitamine B5.", rating:4.6, reviews:14},
  {id:'b22', cat:'body', name:"Medix 5.5 Lotion", subtitle:"Lait", price:40, img:'images/Medix lait.jpeg', seed:'lait-medix', desc:"Lait corporel dermatologique Medix 5.5. Équilibre le pH et hydrate en douceur.", ingredients:"Complexe Medix 5.5, aloe vera, panthénol.", rating:4.4, reviews:8},
  {id:'b23', cat:'body', name:"Bride Cream Lotion", subtitle:"Lait", price:50, img:'images/Bride Cream.jpeg', seed:'lait-bride-cream', desc:"Préparation intense pour future mariée. Éclat extrême et peau de velours pour le grand jour.", ingredients:"Collagène, élastine, extrait de perle, vitamine E.", rating:4.8, reviews:22, badge:'Vedette'},
  ...
  {id:'b26', cat:'body', name:"Roushun Beauty Lotion", subtitle:"Lait", price:19, img:'images/Roushum.jpeg', seed:'lait-roushun', desc:"Lait de beauté Roushun. Formule douce et efficace pour un corps sublimé au quotidien.", ingredients:"Beurre de mangue, huile d'amande, niacinamide.", rating:4.4, reviews:9},
  /* ===== SAVONS ===== */
  {id:'b27', cat:'body', name:"Molato Soap", subtitle:"Savon", price:20, seed:'savon-molato', desc:"Savon éclaircissant extra fort au molato. Nettoie en profondeur tout en unifiant le teint.", ingredients:"Extrait de molato, beurre de karité bio, glycérine.", rating:4.6, reviews:18},
  {id:'b28', cat:'body', name:"Savon Noir", subtitle:"Savon", price:30, seed:'savon-noir', desc:"Savon noir traditionnel africain. Purifie, exfolie et nettoie en douceur. Utilisé depuis des siècles.", ingredients:"Cendre de néré, beurre de karité, huile de palme rouge.", rating:4.4, reviews:12},
  {id:'b29', cat:'body', name:"Pure Egyptian Soap", subtitle:"Savon", price:15, seed:'savon-egyptian', desc:"Savon égyptien pur. Tradition ancestrale pour une peau nette et lumineuse.", ingredients:"Huile d'olive, miel, lait de chèvre.", rating:4.5, reviews:14},
  {id:'b30', cat:'body', name:"Moroccan Argan Soap", subtitle:"Savon", price:15, img:'images/Morrocan soap.jpeg', seed:'savon-argan', desc:"Savon marocain à l'huile d'argan. Nourrit et nettoie sans agresser la peau.", ingredients:"Huile d'argan, huile d'olive, argile ghassoul.", rating:4.6, reviews:16},
  {id:'b31', cat:'body', name:"AHA Savon", subtitle:"Savon", price:15, img:'images/AHA soap.jpeg', seed:'savon-aha', desc:"Savon exfoliant aux AHA. Nettoie et renouvelle la peau en douceur.", ingredients:"Acide glycolique, aloe vera, glycérine.", rating:4.5, reviews:11},
  {id:'b32', cat:'body', name:"Advanced Whitening Soap", subtitle:"Savon", price:15, img:'images/Advanced whitening soap.jpeg', seed:'savon-advanced-whitening', desc:"Savon éclaircissant avancé. Formule concentrée pour un résultat visible.", ingredients:"Arbutine, vitamine C, extrait de citron.", rating:4.6, reviews:15},
  {id:'b33', cat:'body', name:"Half Cast Soap", subtitle:"Savon", price:15, img:'images/Half cast soap.jpeg', seed:'savon-half-cast', desc:"Savon éclaircissant Half Cast. Nettoie et atténue les taches pigmentaires.", ingredients:"Extrait de citron, huile de coco, glycérine.", rating:4.3, reviews:8},
  {id:'b34', cat:'body', name:"Cindella Soap", subtitle:"Savon", price:20, img:'images/Cindella soap.jpeg', seed:'savon-cindella', desc:"Savon Cindella à la formule exclusive. Laisse la peau propre, douce et éclatante.", ingredients:"Complexe Cindella, huile d'amande, beurre de karité.", rating:4.5, reviews:10},
  {id:'b35', cat:'body', name:"Kojic San Soap", subtitle:"Savon", price:10, seed:'savon-kojic-san', desc:"Savon japonais à l'acide kojique. Éclaircissant doux et efficace pour le visage et le corps.", ingredients:"Acide kojique 2%, extrait de riz, collagène.", rating:4.6, reviews:17},
  {id:'b36', cat:'body', name:"Savon Œuf", subtitle:"Savon", price:20, img:'images/Savon oeuf.jpeg', seed:'savon-oeuf', desc:"Savon à l'œuf. Riche en protéines pour une peau nourrie et régénérée.", ingredients:"Extrait d'œuf, huile d'olive, glycérine naturelle.", rating:4.3, reviews:7},
  {id:'b37', cat:'body', name:"CeraVe Cleanser", subtitle:"Savon", price:20, img:'images/CeraVe Cleanser.jpeg', seed:'savon-cerave', desc:"Nettoyant doux CeraVe aux céramides. Respecte la barrière cutanée. Sans parfum.", ingredients:"Céramides, acide hyaluronique, niacinamide.", rating:4.7, reviews:20},
  ...
  /* ===== CRÈMES VISAGE ===== */
  {id:'f3', cat:'face', name:"Cindella Cream", subtitle:"Visage", price:25, img:'images/cindella cream.jpeg', seed:'face-cindella-cream', desc:"Crème visage Cindella. Formule riche pour un teint uniforme et lumineux.", ingredients:"Complexe Cindella, acide hyaluronique, beurre de karité.", rating:4.6, reviews:16},
  ...
  {id:'f5', cat:'face', name:"Jennie Moon Pro Derma", subtitle:"Visage", price:30, img:'images/Jennie MOON PRO DERMA.jpeg', seed:'face-jennie-moon', desc:"Crème coréenne Jennie Moon. Technologie pro-derma pour une peau parfaite.", ingredients:"Peptides, céramides, extrait de centella asiatica.", rating:4.7, reviews:19, badge:'Premium'},
  {id:'f6', cat:'face', name:"Parley Beauty Cream", subtitle:"Visage", price:20, img:'images/Parley.jpeg', seed:'face-parley', desc:"Crème visage Parley Beauty. Nutrition intense et éclat durable.", ingredients:"Huile de coco, beurre de mangue, vitamine E.", rating:4.5, reviews:12},
  {id:'f7', cat:'face', name:"Dr. Althea 345", subtitle:"Visage", price:25, img:'images/Dr. Althea 345.jpeg', seed:'face-dr-althea-345', desc:"Crème apaisante Dr. Althea 345. Calme les irritations et renforce la barrière cutanée.", ingredients:"Centella asiatica, panthénol, niacinamide.", rating:4.7, reviews:18},
  {id:'f8', cat:'face', name:"Dr. Althea 147", subtitle:"Visage", price:25, img:'images/Dr. ALTHEA 147.jpeg', seed:'face-dr-althea-147', desc:"Crème régénérante Dr. Althea 147. Reparation et nutrition intense.", ingredients:"Miel de manuka, propolis, beurre de karité.", rating:4.6, reviews:15},
  {id:'f9', cat:'face', name:"Skin Light Cream", subtitle:"Visage", price:20, img:'images/Anti-taches.jpeg', seed:'face-skin-light', desc:"Crème éclaircissante visage. Estompe les taches et unifie le teint progressivement.", ingredients:"Acide kojique, extrait de réglisse, vitamine C.", rating:4.5, reviews:13},
  {id:'f10', cat:'face', name:"Saam Cream", subtitle:"Visage", price:30, img:'images/Saam.jpeg', seed:'face-saam', desc:"Crème visage Saam. Soin quotidien pour une peau saine et éclatante.", ingredients:"Beurre de karité, huile d'amande douce, glycérine.", rating:4.4, reviews:10},
  {id:'f11', cat:'face', name:"Kojic Cream", subtitle:"Visage", price:10, img:'images/Kojic-creme.jpeg', seed:'face-kojic-cream', desc:"Crème visage à l'acide kojique. Éclaircissante et protectrice.", ingredients:"Acide kojique 2%, niacinamide, filtres UV.", rating:4.6, reviews:14},
  {id:'f12', cat:'face', name:"Medicube", subtitle:"Visage", price:35, img:'images/MEDICUBE.jpeg', seed:'face-medicube', desc:"Crème coréenne Medicube. Soin anti-âge avancé pour une peau rajeunie.", ingredients:"Adénosine, collagène marin, acide hyaluronique.", rating:4.7, reviews:20, badge:'Premium'},
  {id:'f13', cat:'face', name:"COSRX Crème", subtitle:"Visage", price:35, img:'images/COSRX.jpeg', seed:'face-cosrx', desc:"Crème COSRX. Soin apaisant et réparateur à la mucine d'escargot.", ingredients:"Mucine d'escargot 96%, extrait de feuille d'olivier.", rating:4.8, reviews:23},
  {id:'f14', cat:'face', name:"CeraVe Crème Visage", subtitle:"Visage", price:35, img:'images/Cerave-creme.jpeg', seed:'face-cerave', desc:"Crème hydratante CeraVe aux céramides. Hydratation longue durée.", ingredients:"Céramides, acide hyaluronique, niacinamide.", rating:4.7, reviews:19},
  {id:'f15', cat:'face', name:"La Roche Posay", subtitle:"Visage", price:35, img:'images/La roche Posay.jpeg', seed:'face-lrp', desc:"Crème dermatologique La Roche Posay. Tolérance maximale et efficacité prouvée.", ingredients:"Eau thermale de La Roche Posay, niacinamide, shea butter.", rating:4.8, reviews:25, badge:'Premium'},
  ...
  {id:'f17', cat:'face', name:"Joseon Beauty Cream", subtitle:"Visage", price:25, img:'images/Joseon Beauty cream.jpeg', seed:'face-jeason', desc:"Crème Joseon Beauty. Soin visage complet pour un teint frais et unifié.", ingredients:"Complexe Joseon, huile de jojoba, aloe vera.", rating:4.4, reviews:9},
  {id:'f18', cat:'face', name:"Anua 77%", subtitle:"Visage", price:35, img:'images/Anua 77.jpeg', seed:'face-anua-77', desc:"Sérum-crème Anua 77% à l'extrait d'huile d'olive. Hydratation coréenne intense.", ingredients:"Extrait d'huile d'olive 77%, squalane, panthénol.", rating:4.7, reviews:17},
  {id:'f19', cat:'face', name:"Anua 70%", subtitle:"Visage", price:35, img:'images/Anua 70.jpeg', seed:'face-anua-70', desc:"Crème Anua 70% à la centella. Apaise et répare les peaux sensibles.", ingredients:"Extrait de centella asiatica 70%, niacinamide, madecassoside.", rating:4.6, reviews:15},
];
...
/* ===== TEAM ===== */
const TEAM = [
  { id:'hamin', name:'Hamin Banga', role:'CEO & Fondateur', roleKey:'', bio:"Visionnaire et fondateur de Malkia B Cosmetics, Hamin incarne l'ambition de rendre la beauté premium accessible à toutes. Sous sa direction, la marque rayonne depuis Bukavu et Kigali vers le monde.", img:'images/CEO.jpeg' },
