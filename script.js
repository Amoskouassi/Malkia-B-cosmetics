...
const PRODUCTS = [
  ...
  {id:'r22', cat:'fragrance', name:"Moussuf Bleu", subtitle:"Parfums", price:100, img:'images/Mousuf Aswad.jpeg', seed:'parfum-moussuf-bleu', desc:"Moussuf version bleue. Fraîcheur aquatique et florale.", ingredients:"Notes marines, lavande, musc.", rating:4.4, reviews:12},
  {id:'r23', cat:'fragrance', name:"Moussuf Rouge", subtitle:"Parfums", price:100, img:'images/Mousuf Sexy.jpeg', seed:'parfum-moussuf-rouge', desc:"Moussuf version rouge. Passion et intensité.", ingredients:"Fraise, rose rouge, ambre.", rating:4.5, reviews:10},
  {id:'r24', cat:'fragrance', name:"Moussuf Rose", subtitle:"Parfums", price:100, img:'images/Mousuf Wardi.jpeg', seed:'parfum-moussuf-rose', desc:"Moussuf version rose. Douceur florale et romantique.", ingredients:"Rose, pivoine, musc blanc.", rating:4.4, reviews:9},
  {id:'r25', cat:'fragrance', name:"Moussuf Chocolat", subtitle:"Parfums", price:100, img:'images/Mousuf Chocolat.jpeg', seed:'parfum-moussuf-choco', desc:"Moussuf version chocolatée. Gourmandise addictive.", ingredients:"Cacao, vanille, caramel.", rating:4.5, reviews:11},
  {id:'r26', cat:'fragrance', name:"Moussuf Blanc", subtitle:"Parfums", price:100, img:'images/Mousf Musk.jpeg', seed:'parfum-moussuf-blanc', desc:"Moussuf version blanche. Pureté et élégance minimaliste.", ingredients:"Fleur d'oranger, musc, vanille.", rating:4.3, reviews:8},
  {id:'r30', cat:'fragrance', name:"Moussuf Gris", subtitle:"Parfums", price:100, img:'images/Mousuf Ramadi.jpeg', seed:'parfum-moussuf-ramadi', desc:"Moussuf version grise. Élégance sobre et moderne.", ingredients:"Cèdre, poivre rose, musc gris.", rating:4.3, reviews:6},
