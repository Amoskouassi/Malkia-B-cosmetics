...
const PRODUCTS = [
  ...
  {id:'b17', cat:'body', name:"Vitamine C Lotion", subtitle:"Lait", price:20, seed:'lait-vitamine-c', desc:"Lotion illuminatrice riche en vitamine C stabilisée. Éclat immédiat et protection antioxydante.", ingredients:"Vitamine C 10%, extrait d'orange, vitamine E.", rating:4.5, reviews:12},
  ...
  /* ===== CRÈMES VISAGE ===== */
  {id:'f3', cat:'face', name:"Cindella Cream", subtitle:"Visage", price:25, seed:'face-cindella-cream', desc:"Crème visage Cindella. Formule riche pour un teint uniforme et lumineux.", ingredients:"Complexe Cindella, acide hyaluronique, beurre de karité.", rating:4.6, reviews:16},
