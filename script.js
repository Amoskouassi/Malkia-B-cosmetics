...
const TR = {
  fr: {
    ...
    hero: { title:["L'Éclat de la","Reine en Vous"], subtitle:"Des soins de beauté soigneusement sélectionnés, inspirés par la richesse de l'Afrique.",
      ...
      slide3_tag:"Soins Bien-être", slide3_title:"Prenez Soin de Vous",
      slide3_text:"Des soins de beauté pensés pour votre bien-être au quotidien." },
    home: { latest:"Dernières Créations", see_all:"Voir toute la boutique", story:"Notre histoire",
      ...
      story_p2:"Chaque produit que nous proposons est le fruit d'une sélection rigoureuse. Mon équipe et moi mettons un point d'honneur à choisir des produits qui allient efficacité, sécurité et élégance. Notre succès, je le dois à la confiance de milliers de femmes qui ont choisi la beauté souveraine.",
      since:"Depuis", delivery:"Livraison",
      join:"Rejoignez le Cercle Malkia", join_p:"Inscrivez-vous pour recevoir nos soins de beauté exclusifs, nos nouvelles collections et des invitations pour nos évènements privés.",
    ...
    story: { title:"Notre Histoire", subtitle:"L'héritage d'une beauté souveraine",
      p1:"Je suis Hamin Banga, fondateur de Malkia B Cosmetics. Tout est parti d'une conviction simple : chaque femme a le droit de se sentir souveraine. J'ai voulu offrir des soins qui ne transforment pas seulement la peau, mais aussi la confiance.",
    ...
    contact: { title:"Contactez-nous", heading:"Une question sur nos soins de beauté ?",
      desc:"Que vous recherchiez un conseil personnalisé ou des informations sur nos produits, notre équipe est à votre écoute.",
  ...
  en: {
    ...
    hero: { title:["The Radiance of the","Queen Within You"], subtitle:"Curated beauty care, inspired by Africa's richness.",
      ...
      slide3_tag:"Wellness Care", slide3_title:"Take Care of Yourself",
      slide3_text:"Beauty care designed for your daily well-being." },
    home: { latest:"Latest Creations", see_all:"View All Products", story:"Our Story",
      ...
      story_p2:"Every product we offer is the result of rigorous selection. My team and I take great care in choosing products that combine effectiveness, safety and elegance. Our success I owe to the trust of thousands of women who have chosen sovereign beauty.",
      since:"Since", delivery:"Delivery",
      join:"Join the Malkia Circle", join_p:"Sign up to receive our exclusive beauty care, new collections, and invitations to our private events.",
    ...
    story: { title:"Our Story", subtitle:"The legacy of sovereign beauty",
      p1:"I am Hamin Banga, founder of Malkia B Cosmetics. It all started with a simple belief: every woman deserves to feel sovereign. I wanted to offer products that don't just transform the skin, but also transform confidence.",
    ...
    shops: { title:"Our Boutiques", subtitle:"Dedicated spaces for your beauty",
      ...
      kigali:{ name:"Kigali Boutique", tag:"Flagship Store", addr:"KG 123 St — Kigali, Rwanda",
        ...
        lat:"-1.9441", lng:"30.0619", q:"Kigali,Rwanda" } },
    contact: { title:"Contact Us", heading:"A question about your beauty care?",
      desc:"Whether you need personalized advice or information about our products, our team is here to help.",
...
const PRODUCTS = [
  ...
  /* ===== LAITS (BODY LOTIONS) ===== */
  {id:'b4', cat:'body', name:"Déla Yellow", subtitle:"Lait", price:50, img:'images/Dela Yellow.jpeg', seed:'lait-dela-yellow', desc:"Lait corporel éclat à l'extrait de curcuma. Illumine et unifie le teint progressivement. Texture légère et non collante.", ingredients:"Curcuma bio, beurre de karité, vitamine E.", rating:4.5, reviews:12},
  {id:'b5', cat:'body', name:"Biovène Éclat Suprême", subtitle:"Lait", price:40, img:'images/Biovene eclat supreme.jpeg', seed:'lait-biovene', desc:"Soin corps illuminant à la vitamine C. Éclat suprême et hydratation longue durée. Pénètre rapidement.", ingredients:"Vitamine C stabilisée, acide hyaluronique, huile d'amande douce.", rating:4.7, reviews:18, badge:'Vedette'},
  ...
  {id:'b7', cat:'body', name:"Lait Vietnam", subtitle:"Lait", price:30, img:'images/Lait vietnam.jpeg', seed:'lait-vietnam', desc:"Lotion corporelle légère venue du Vietnam. Absorption rapide, senteur subtile et fraîcheur durable.", ingredients:"Extrait de riz, huile de coco, aloe vera.", rating:4.3, reviews:7},
  ...
  {id:'b9', cat:'body', name:"Final Glow Cast", subtitle:"Lait", price:40, img:'images/Final Glow.jpeg', seed:'lait-final-glow', desc:"Lotion finalisante pour un glow parfait. Scelle l'hydratation et sublime l'éclat naturel de la peau.", ingredients:"Complexe éclat, huile de jojoba, vitamine E.", rating:4.6, reviews:14},
  ...
  {id:'b43', cat:'body', name:"Gamme de Cindella", subtitle:"Lait", price:150, img:'images/Gamme de cindella.jpeg', seed:'lait-cindella-gamme', desc:"Ensemble complet de la gamme Cindella. Lotion, savon et crème pour une routine éclat parfaite.", ingredients:"Complexe Cindella, huile d'argan, beurre de karité, vitamine E.", rating:4.7, reviews:5, badge:'Vedette'},
  ...
  {id:'b13', cat:'body', name:"Advanced Korean Skin", subtitle:"Lait", price:40, img:'images/Advanced Korean skin.jpeg', seed:'lait-korean-skin', desc:"Lait corporel premium à la coréenne. Technologie avancée pour une peau glass-skin. Hydratation profonde.", ingredients:"Essence de riz fermenté, niacinamide, peptides.", rating:4.8, reviews:21, badge:'Premium'},
  {id:'b14', cat:'body', name:"Piment Doux Lotion", subtitle:"Lait", price:40, img:'images/Piment doux.jpeg', seed:'lait-piment-doux', desc:"Lotion chauffante au piment doux. Stimule la microcirculation et réchauffe la peau.", ingredients:"Extrait de piment doux, huile de sésame, vitamine E.", rating:4.2, reviews:8},
  {id:'b15', cat:'body', name:"Maakari Lotion", subtitle:"Lait", price:40, img:'images/Makari lotion.jpeg', seed:'lait-maakari', desc:"Lait corporel traditionnel aux ingrédients naturels. Hydrate et adoucit durablement.", ingredients:"Beurre de karité, huile de palme rouge, extrait de miel.", rating:4.4, reviews:9},
  ...
  {id:'b18', cat:'body', name:"Françoise Bedon Lotion", subtitle:"Lait", price:60, img:'images/Françoise bredon.jpeg', seed:'lait-fb', desc:"Lait corporel de la célèbre marque ivoirienne. Formule originale pour une peau éclatante.", ingredients:"Beurre de karité bio, extrait de cacao, vitamine E.", rating:4.6, reviews:17},
  {id:'b19', cat:'body', name:"Advanced Whitening Lotion", subtitle:"Lait", price:50, img:'images/Advanced Whitening Lotion.jpeg', seed:'lait-advanced-whitening', desc:"Lotion éclaircissante avancée. Technologie double action pour un teint uniforme et radieux.", ingredients:"Arbutine, niacinamide, extrait de citron.", rating:4.7, reviews:19},
  {id:'b20', cat:'body', name:"Glutathione Lotion", subtitle:"Lait", price:10, img:'images/Lait Glutathione.jpeg', seed:'lait-glutathione', desc:"Lait corporel au glutathion. Antioxydant puissant pour une peau lumineuse et protégée.", ingredients:"Glutathion, vitamine C, acide férulique.", rating:4.5, reviews:11},
  ...
  {id:'b24', cat:'body', name:"Skin Doctor Lotion", subtitle:"Lait", price:30, img:'images/Skin Doctor.jpeg', gallery:['images/Skin Doctor.jpeg','images/Skin Doctor 1.jpeg'], seed:'lait-skin-doctor', desc:"Lotion professionnelle Skin Doctor. Soin expert pour une peau saine et radieuse.", ingredients:"Complexe dermatologique, céramides, acide hyaluronique.", rating:4.5, reviews:10},
  {id:'b25', cat:'body', name:"Vaseline Lotion", subtitle:"Lait", price:20, img:'images/Vaseline Lotion.jpeg', seed:'lait-vaseline', desc:"Lotion hydratante intense à la vaseline pure. Protection et nutrition longue durée.", ingredients:"Vaseline pure, glycérine, vitamine E.", rating:4.3, reviews:7},
  ...
  {id:'b42', cat:'body', name:"Biovène", subtitle:"Lait", price:30, img:'images/Biovene.jpeg', seed:'lait-biovene-general', desc:"Lait corporel Biovène. Hydratation quotidienne pour une peau douce et lumineuse.", ingredients:"Vitamine E, beurre de karité, huile d'amande douce.", rating:4.5, reviews:6},
  /* ===== SAVONS ===== */
  {id:'b27', cat:'body', name:"Molato Soap", subtitle:"Savon", price:20, img:'images/savon molato.jpeg', seed:'savon-molato', desc:"Savon éclaircissant extra fort au molato. Nettoie en profondeur tout en unifiant le teint.", ingredients:"Extrait de molato, beurre de karité bio, glycérine.", rating:4.6, reviews:18},
  ...
  {id:'b33', cat:'body', name:"Half Cast Soap", subtitle:"Savon", price:15, img:'images/Half cast.jpeg', seed:'savon-half-cast', desc:"Savon éclaircissant Half Cast. Nettoie et atténue les taches pigmentaires.", ingredients:"Extrait de citron, huile de coco, glycérine.", rating:4.3, reviews:8},
  ...
  {id:'b38', cat:'body', name:"Medix Soap", subtitle:"Savon", price:10, img:'images/Medix soap.jpeg', seed:'savon-medix', desc:"Savon dermatologique Medix. Nettoie en douceur tout en respectant l'équilibre de la peau.", ingredients:"Complexe Medix, aloe vera, panthénol.", rating:4.4, reviews:9},
  {id:'b39', cat:'body', name:"Pure Glow Soap", subtitle:"Savon", price:15, img:'images/Pure Glow.jpeg', seed:'savon-pure-glow', desc:"Savon éclat pur. Illumine la peau dès la première utilisation.", ingredients:"Extrait de perle, vitamine C, huile de jojoba.", rating:4.5, reviews:13},
  {id:'b40', cat:'body', name:"Arbutin Glutathione Soap", subtitle:"Savon", price:15, img:'images/Arbutin soap.jpeg', seed:'savon-arbutin-gluta', desc:"Savon double action arbutine et glutathion. Puissant éclaircissant et antioxydant.", ingredients:"Alpha arbutine, glutathion, vitamine E.", rating:4.6, reviews:15},
  {id:'b41', cat:'body', name:"L-Gluta Soap", subtitle:"Savon", price:15, img:'images/L-GLUTA SOAP.jpeg', seed:'savon-l-gluta', desc:"Savon au L-glutathion. Blanchissant et antioxydant pour une peau lumineuse.", ingredients:"L-glutathion, vitamine C, extrait de papaye.", rating:4.5, reviews:11},
  /* ===== CRÈMES VISAGE ===== */
...
const HERO_SLIDES = [
  {
    ...
    title: "La vraie beauté vient de l'intérieur.",
    text: 'Des soins premium inspirés des traditions ancestrales.',
